...
прошли Linux/macOS, а Windows выявил проблему размеров окна в тесте repeat-панели.
Исправленный тест требует нового удалённого прогона после push. Точные commits, ссылки
...
в свойствах JUnit. Минимальная ширина самого редактора — 1104 px.
