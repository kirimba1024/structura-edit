...
class PlacementBar(OverlayBar):
    ...
    def _create_options(self, layout):
        ...
        layout.addWidget(self.transform_grid, 1, 0, 1, 4, Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignTop)
        ...
        controls.setSpacing(GRID)
        controls.setColumnStretch(0, 1)
        controls.setColumnStretch(1, 3)
        controls.setRowStretch(1, 1)
        controls.addWidget(self.more, 0, 0)
        controls.addWidget(self.destination, 0, 1)
        controls.addWidget(self.hint, 1, 0, 1, 2)
        layout.addWidget(options, 1, 4, 1, 8)
